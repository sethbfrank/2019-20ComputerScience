...
public class BankTester
{
    public static void main (String[] args)
    {
        ...
        b1.replaceBigShots(new Employee("George","Bob",30,"President",100000,"10-421-8906"), new Employee("Michael","Bob",30,"Vice President",10000,"10-421-5367"));
        b1.printCompanyReport();
        ...
        b2.replaceBigShots(new Employee("George","Bob",30,"President",100000,"10-421-8906"), new Employee("Michael","Bob",30,"Vice President",10000,"10-421-5367"));
        b2.printCompanyReport();
        ...
        b3.replaceBigShots(new Employee("George","Bob",30,"President",100000,"10-421-8906"), new Employee("Michael","Bob",30,"Vice President",10000,"10-421-5367"));
        b3.printCompanyReport();
        ...
        b4.replaceBigShots(new Employee("George","Bob",30,"President",100000,"10-421-8906"), new Employee("Michael","Bob",30,"Vice President",10000,"10-421-5367"));
        b4.printCompanyReport();
